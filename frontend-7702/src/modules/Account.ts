...
import { type Client, queryClient } from "@/components/providers/NoneProviders";
import { ExperimentDelegation } from "../contracts";
// import { encodeTypedData, hashTypedData } from "viem/utils";
...
export namespace Account {
  ...
  export async function signCustom({
    hash,
    account,
  }: {
    hash: `0x${string}`;
